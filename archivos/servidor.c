...
<<<<<<< HEAD
       ...
       // printf("%d\n", status);
        if( status <= 0){
=======
        if(recv(server_write_t.newsockfd, buffer, sizeof(buffer), 0) < 0){
>>>>>>> 40118d2f7675c6f9048e4f66793c3687c7346c3a
        ...
        if(strcmp(buffer, "subir") == 0){
            ...
            recibirArchivo(server_write_t.newsockfd);
        }else if(strcmp(buffer, "bajar") == 0){
            printf("Preparando archivo...\n");
            enviarArchivo(server_write_t.newsockfd);
...
<<<<<<< HEAD
        ...
        // exit(0);
=======
        //close(server_write_t.newsockfd);
      //  exit(0);
>>>>>>> 40118d2f7675c6f9048e4f66793c3687c7346c3a
    }
